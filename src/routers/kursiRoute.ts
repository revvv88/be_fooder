...
import { getAllKursi, getKursiById, createKursi,updateKursi, deleteKursi, getKursiByJadwalAndGerbong } from "../controllers/kursiController"
...
app.get(`/`,getAllKursi)
app.get(`/kelasKereta/:id`, getKursiById)
app.post(`/`, createKursi)
app.put(`/:id`, updateKursi)
app.put(`/profile/:id`)
app.delete(`/:id`, deleteKursi)
app.get('/cekKursi', getKursiByJadwalAndGerbong)
